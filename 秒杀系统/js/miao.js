...
{
	if (obj.errno == 0) {
		document.getElementById("DaoJiShi").innerHTML = '立即秒杀';
		document.getElementById("DaoJiShi").style.backgroundColor = 'red';
...
function canBuy(obj) {
	if (obj.errno == 0  && obj.data.available!=1) {
		...
		document.getElementById("DaoJiShi").innerHTML = '已抢光';
		document.getElementById("DaoJiShi").style.backgroundColor = 'gray';
	}
}
